...
export const meta: MetaFunction = () => [
  { title: "Edit Shared Accounts – Keep Information Updated" },
  {
    name: "description",
    content:
      "Modify existing shared accounts to ensure accuracy and usability. Keep the community database clean and reliable!",
  },
];
