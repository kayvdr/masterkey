...
import styles from "../components/Imprint/ImprintPage.module.css";

export const meta: MetaFunction = () => [
  { title: "Legal Notice – MasterKey Imprint & Contact Info" },
  {
    name: "description",
    content:
      "Official imprint and legal details of MasterKey. Contact information and compliance with online regulations.",
  },
];
