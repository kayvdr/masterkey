...
export const meta: MetaFunction = () => [
  { title: "Create an Account – Join MasterKey for Free" },
  {
    name: "description",
    content:
      "Sign up for MasterKey and start accessing or sharing login credentials instantly. Free registration, no hassle!",
  },
];
