...
const SvgPixabay: Glyph = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300" {...props}>
    <path fill="#48a947" d="M0 0v300h300V0H0z" />
    <path
      fill="#f9fbf9"
    ...
    <path
      fill="#fafcfa"
      d="m238.9 140 48.5 68.2H256l-36-49.3c-13.1 16.3-24 33.2-36.4 49.3h-31.3l48.4-68.2-43.1-64.6H189l30.8 46 30.8-46h31.3l-43 64.6z"
    />
    <path
      fill="#4aa949"
